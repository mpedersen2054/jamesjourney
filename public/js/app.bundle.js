...
exports.adminPageRenderer = adminPageRenderer;
exports.handleAdminEventAttendees = handleAdminEventAttendees;
exports.handleAdminEventAttendeesMessages = handleAdminEventAttendeesMessages;
exports.tokenField = tokenField;
exports.contentPreviewCount = contentPreviewCount;
exports.formatDate = formatDate;
exports.formatDonation = formatDonation;
exports.editGalleryImageName = editGalleryImageName;
...
function handleAdminEventAttendees() {
...
function handleAdminEventAttendeesMessages() {
...
into input field
*/
function tokenField(elem) {
  var $newBlogTokenField = $('#new-blog-tokenfield');
  ...
  $editImgBtn.on('click', function (e) {
    ...
    $('.edit-img-form').on('submit', function (e) {
      ...
      if ($input.val() === imgNameTdTxt || $input.val() === '') {
        ...
        $.post('/gallery/' + imgref, submitData).done(function (data) {
...
exports.handleDonateSubmit = handleDonateSubmit;
exports.bootstrapSelect = bootstrapSelect;
exports.showTotalFee = showTotalFee;
...
var $nameOnCard = $registerForm.find('#nameOnCard');
var $cardNumber = $registerForm.find('#cardNumber');
var $expMonth = $registerForm.find('#expMonth');
var $expYear = $registerForm.find('#expYear');
var $cvcCode = $registerForm.find('#cvcCode');

var $regSuccess = $('.register-success');
var $regError = $('.register-error');

// handleDonateSubmit variables
var $spinner = $('<i/>', { class: 'fa fa-circle-o-notch fa-spin fa-2x fa-fw' });
var $srOnly = $('<span/>', { class: 'sr-only' });
...
var $radioRegisterOpts = $("input[name='registerOptions']");
...
},{"imagesloaded":5,"jquery-bridget":6,"masonry-layout":8}],15:[function(require,module,exports){
'use strict';
...
var _global_controller = require('./controllers/global_controller');

var globals = _interopRequireWildcard(_global_controller);

var _statics_controller = require('./controllers/statics_controller');

var statics = _interopRequireWildcard(_statics_controller);

var _form_controller = require('./controllers/form_controller');

var forms = _interopRequireWildcard(_form_controller);

var _admin_controller = require('./controllers/admin_controller');

var admins = _interopRequireWildcard(_admin_controller);

var _blogs_controller = require('./controllers/blogs_controller');

var blogs = _interopRequireWildcard(_blogs_controller);

var _galleries_controller = require('./controllers/galleries_controller');

var galleries = _interopRequireWildcard(_galleries_controller);
