...
var _bootstrapTokenfield = require('bootstrap-tokenfield');

var _bootstrapTokenfield2 = _interopRequireDefault(_bootstrapTokenfield);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function tokenField(elem) {
  var $newBlogTokenField = (0, _jquery2.default)('#new-blog-tokenfield');
...
function contentPreviewCount() {
  var currentNum;
  var maxNum = 600;
  var $contentPreview = (0, _jquery2.default)('.content-preview-input');
  var $currentCount = (0, _jquery2.default)('.current-count');
  var $maxNum = (0, _jquery2.default)('.current-count__max');
  var $currentNum = (0, _jquery2.default)('.current-count__current');
...
},{"bootstrap-tokenfield":1,"jquery":2}],4:[function(require,module,exports){
"use strict";
...
var $registerForm = (0, _jquery2.default)('#event-register-form');
...
var $regSuccess = (0, _jquery2.default)('.register-success');
var $regError = (0, _jquery2.default)('.register-error');

// handleDonateSubmit variables
var $spinner = (0, _jquery2.default)('<i/>', { class: 'fa fa-circle-o-notch fa-spin fa-2x fa-fw' });
var $srOnly = (0, _jquery2.default)('<span/>', { class: 'sr-only' });
var $donateForm = (0, _jquery2.default)('#donate-form');
var $spinnerContainer = (0, _jquery2.default)('.spinner-container');
...
function handleRegisterSubmit() {
  ...
  $registerForm.on('submit', function (e) {
    ...
    var data = {
      f_name: $fName.val(),
      l_name: $lName.val(),
      full_name: _jquery2.default.trim($fName.val()) + ' ' + _jquery2.default.trim($lName.val()),
      email: $email.val(),
      message: $message.val(),
      slug: $slug.val(),
    ...
    _jquery2.default.post('/events/' + data.slug + '/register', data, function (result) {
...
function handleDonateSubmit() {
  ...
  function stripeResponseHandler(status, response) {
    ...
    if (response.error) {
      ...
      $form.append((0, _jquery2.default)('<input type="hidden" name="stripeToken" />').val(token));
      // and submit
      $form.get(0).submit();
    }
  };
...
var $navbar = (0, _jquery2.default)('header');
var $window = (0, _jquery2.default)(window);
var $logo = (0, _jquery2.default)('#header-logo-link');
var $menu = (0, _jquery2.default)('#header-menu-link');
var $navbarBtn = (0, _jquery2.default)('a#header-menu-link');
var $mainCont = (0, _jquery2.default)('.main-cont');
var $siteHeader = (0, _jquery2.default)('header.site-header');
var $navMenu = (0, _jquery2.default)('#nav-menu');
...
function navbar() {
  $window.on('scroll change', function () {
    ...
    if ((0, _jquery2.default)(this).scrollTop() > 20) {
...
var $pSlider = (0, _jquery2.default)('#programs-slider');
...
function slideShow() {
  ...
  function animateSlider(err) {
    ...
    var sliderArr = [];
    var $slider = (0, _jquery2.default)('ul#slider');
    var $slideItems = (0, _jquery2.default)('.slider__item');
    ...
    setInterval(function () {
      ...
      item = (0, _jquery2.default)("li.slider__item[data-position='" + count + "']");
      item.addClass('show');
    }, 6000);
  }
  ...
  function buildSliderDom(imgLinks, callback) {
    ...
    for (var i = 0; i < sliderArr.length; i++) {
      ...
      var item = (0, _jquery2.default)('<li/>', {
        'class': 'slider__item',
        'data-position': i
      });
...
var _gallery_controller = require('./controllers/gallery_controller');

var gallery = _interopRequireWildcard(_gallery_controller);
...
App.handleAdminEventAttendees = function () {
  var $createdAt = (0, _jquery2.default)('.attendee__created-at');
  var $attendeeMessage = (0, _jquery2.default)('.attendee__message');
  var $viewAttendeesBtn = (0, _jquery2.default)('.btn-attendees');
  var $attendeeRow = (0, _jquery2.default)('.attendee-row, .attendee-meta-row');
...
App.handleAdminEventAttendeesMessage = function () {
  var $popovers = (0, _jquery2.default)('[data-toggle="popover"]');
...
App.adminPageRenderer = function () {
  var $adminSections = (0, _jquery2.default)('.admin-section');
  var $adminAll = (0, _jquery2.default)('.admin-section__all');
  var $adminBlogs = (0, _jquery2.default)('.admin-section__blogs');
  var $adminEvents = (0, _jquery2.default)('.admin-section__events');
  var $adminSubs = (0, _jquery2.default)('.admin-section__subscribers');
  var $adminImages = (0, _jquery2.default)('.admin-section__gallery');
  var $adminDonations = (0, _jquery2.default)('.admin-section__donations');
  var $adminLinks = (0, _jquery2.default)('.admin-link');
  var $adminLinkAll = (0, _jquery2.default)('.admin-link__all');
  var $adminLinkBlogs = (0, _jquery2.default)('.admin-link__blogs');
  var $adminLinkEvents = (0, _jquery2.default)('.admin-link__events');
  var $adminLinkSubs = (0, _jquery2.default)('.admin-link__subscribers');
  var $adminLinkImages = (0, _jquery2.default)('.admin-link__gallery');
  var $adminLinkDonations = (0, _jquery2.default)('.admin-link__donations');
