...
// html template for sendgrid email
var emailTmpl = function(subject, content) {
return `
<html>
  <head>
      <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
      <title>James' Journey</title>
                      ...
                      <tr>
                          <td>
                              <div class="logo" style="text-align: center;">
                                  <img src="https://dft010l2k5dxv.cloudfront.net/jumbo-logo-header.png" style="height: 160px; width: 400px;" alt="Logo">
                              </div>
...
const sendEmail = function(opts, callback) {
  ...
  var html = emailTmpl(subject, content);
